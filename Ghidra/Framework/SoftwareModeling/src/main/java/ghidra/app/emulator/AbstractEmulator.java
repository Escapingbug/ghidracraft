...
public abstract class AbstractEmulator {
	...
	protected FilteredMemoryState memState;
	protected ghidra.pcode.emulate.BreakTableCallBack breakTable;
	...
	public AbstractEmulator(EmulatorConfiguration cfg) {
	...
	public abstract void setExecuteAddress(long addressableWordOffset); /*{
	...
	/* public abstract Address getLastExecuteAddress(); {
	 ...
	 */
	protected List<String> disassemble(Integer count, EmulateDisassemblerContext context) {
		...
		EmulateDisassemblerContext disassemblerContext = context;
