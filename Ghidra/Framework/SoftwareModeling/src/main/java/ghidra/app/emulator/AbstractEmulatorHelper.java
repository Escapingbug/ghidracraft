...
public abstract class AbstractEmulatorHelper implements MemoryFaultHandler, EmulatorConfiguration {
		...
		return new EmulatorLoadData() {
			...
			public MemoryLoadImage getMemoryLoadImage() {
				return new ProgramMappedLoadImage(
					new ProgramMappedMemory(program, AbstractEmulatorHelper.this));
			}
	 ...
	 */
	public abstract void setBreakpoint(Address addr);
	 ...
	 */
	protected abstract void continueExecution(TaskMonitor monitor) throws CancelledException;
	...
	public abstract boolean step(TaskMonitor monitor) throws CancelledException;
	...
	protected abstract boolean isInstructionDecoding();
